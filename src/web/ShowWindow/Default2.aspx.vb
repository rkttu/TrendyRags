...
Partial Class ShowWindow_Default2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call renderPage()
        Session.Item("CurrentPage") = "~/ShowWindow/Default.aspx?CN=" & ClassName & "&CV=" & ClassValue & "&CP=" & CurrentPage & " &GD=" & Gender
    ...
    Private Sub listProduct()
        ...
        Select Case ClassName
            Case "Brand"
                ...
                sqlList += "           WHERE ( (BrandName=@ClassValue) And (Status='Live') And (Gender=@Gender) And (WebDisplay='YES')  And (ExclusiveSales<>'Exclusive') )  "
                sqlList += "           Order By DisplayOrder Desc, ProductNo "

            Case "Category"
                sqlList = "SELECT  * FROM ProductMaster "
                sqlList += "                 WHERE ( (Category=@ClassValue) And (Status='Live') And (Gender=@Gender) And (WebDisplay='YES')  And (ExclusiveSales<>'Exclusive') )  "
    ...
    Protected Sub lbtnViewAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtnViewAll.Click
        ...
        Response.Redirect("Default.aspx?CN=" & ClassName & "&CV=" & ClassValue & "&GD=" & Gender)
