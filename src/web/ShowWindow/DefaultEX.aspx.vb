...
Partial Class ShowWindow_DefaultEX
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call renderPage()
        Session.Item("CurrentPage") = NSRoot + "ShowWindow/Default.aspx?CN=Exclusive&CP=" & CurrentPage
    ...
    Private Sub renderPage()
        ...
        For ni = 1 To nTotalPages
            ...
            If ni = CurrentPage Then
                strList += "<a href=""Default.aspx?CN=Exclusive&CP=" & ni & """>&nbsp;<font size=""3"">[<b>" & Trim(Str(ni)) & "</b>]</font>&nbsp;</a>"
            Else
                strList += "<a href=""Default.aspx?CN=Exclusive&CP=" & ni & """>&nbsp;<font size=""2"">" & Str(ni) & "</font>&nbsp;</a> "
            End If
        Next
    ...
    Protected Sub lbtnViewAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtnViewAll.Click
        ...
        Response.Redirect("DefaultEX2.aspx?CN=Exclusive")
