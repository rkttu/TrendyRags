<%@ Page Language="VB" MasterPageFile="~/Includes/MP1.master" AutoEventWireup="false" CodeFile="DefaultEX2.aspx.vb" Inherits="ShowWindow_DefaultEX2" title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td align="right" style="padding-right: 10px; width: 400px;">
                <asp:Literal ID="ltrListPage" runat="server" Text="1 2 3 4 5" Visible="False"></asp:Literal></td>
            <td align="left">
                <asp:Literal ID="ltrTotalItems" runat="server"></asp:Literal>
                <br />
                <asp:LinkButton ID="lbtnViewAll" runat="server">View Page</asp:LinkButton>
            </td>
        </tr>
    </table>
