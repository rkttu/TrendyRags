<%@ Page Language="VB" MasterPageFile="~/Includes/MP1.master" AutoEventWireup="false" CodeFile="Default_W.aspx.vb" Inherits="Login_Default_W" title="Untitled Page" %>
                ...
                <table width="620">
                    <tr>
                        ...
                        <td style="text-align: left; height: 193px; vertical-align:top; width:250px; padding-top:30px;">
                            <table border="0"   
                                        style="border: thin double #FFFF00; margin-right: 20px; margin-top: 10px; width:240px; height:190px;">
                                <tr>
                                ...
                                <tr>
                                    <td style="padding-right: 7px; padding-bottom: 5px; padding-left: 10px; width: 70px; text-align: right; font-weight: bold; font-size: 11px;">
                                            e-mail</td>
                            ...
                            <table border="0" style="border: thin double #FFFF00; margin-right: 20px; margin-top: 10px; width:230px; height:190px;">
                                ...
                                <tr>
                                    <td colspan="2" 
                                            ...
                                            <em><strong>
                    <span style="font-size: 12px; font-family: Verdana">Some documentation will be required to gain full 
                                            access to our site and its contents.</span></strong></em></td>
                                </tr>
                                <tr>
                                    <td style=" height: 67px; text-align: center;" colspan="2">
